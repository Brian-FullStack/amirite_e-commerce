"""
Django settings for amirite project.
...
SECRET_KEY = 'django-insecure-0wu@wyl2^cc4xtj)0__kf_pz7#tb!6ti^ml#u^offg@*58vywk'
...
WSGI_APPLICATION = 'amirite.wsgi.application'
